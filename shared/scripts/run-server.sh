...
# Resolves the binary, creates the memory dir, guards optional flags by --help,
# then execs the stdio MCP server. Safe for Cursor/Windsurf/Cline/Roo/Continue/OpenCode recipes.
set -uo pipefail
...
SM_TURBO_QUANT="${SEMANTIC_MEMORY_TURBO_QUANT:-}"
