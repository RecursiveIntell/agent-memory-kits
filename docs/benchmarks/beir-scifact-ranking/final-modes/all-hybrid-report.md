...
|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| 0.661843 | 0.510222 | 0.748944 | 0.798333 | 0.623611 | 0.612899 | 0.530000 | 0.770000 | 0.810000 | 0 |

Latency: p50 `62.716 ms`, p95 `70.871 ms`, mean `62.751 ms`.
...
- Per-query JSONL: `/home/sikmindz/Coding/agent-memory-kits/docs/benchmarks/beir-scifact-ranking/final-modes/all-hybrid-per-query.jsonl` (`sha256:d409871979a836a57befdb62b491976c13e6024c87fc9918eacc3ab64ce3a46b`)
...
```bash
python3 shared/scripts/benchmark-beir-scifact-ranking.py --work-dir .bench-data/beir-scifact-ranking --output-dir docs/benchmarks/beir-scifact-ranking/final-modes --model all-minilm:latest --dimensions 384 --max-chars 700 --mode hybrid --query-split all
```
