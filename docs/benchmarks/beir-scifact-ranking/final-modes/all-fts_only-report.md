...
|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| 0.618415 | 0.487222 | 0.686333 | 0.734500 | 0.586710 | 0.575558 | 0.503333 | 0.710000 | 0.756667 | 0 |

Latency: p50 `17.606 ms`, p95 `23.144 ms`, mean `17.665 ms`.
...
- Per-query JSONL: `/home/sikmindz/Coding/agent-memory-kits/docs/benchmarks/beir-scifact-ranking/final-modes/all-fts_only-per-query.jsonl` (`sha256:4f28a80ecc8a758c9c18a0bc5ebba263e15b0242f433f20b73d4bb3ae1a10237`)
...
```bash
python3 shared/scripts/benchmark-beir-scifact-ranking.py --work-dir .bench-data/beir-scifact-ranking --output-dir docs/benchmarks/beir-scifact-ranking/final-modes --model all-minilm:latest --dimensions 384 --max-chars 700 --mode fts_only --query-split all
```
