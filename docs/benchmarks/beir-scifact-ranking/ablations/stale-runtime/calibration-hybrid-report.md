...
|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| 0.646187 | 0.508667 | 0.710667 | 0.788500 | 0.607190 | 0.596518 | 0.530000 | 0.730000 | 0.800000 | 0 |

Latency: p50 `62.161 ms`, p95 `72.517 ms`, mean `62.933 ms`.
...
- Per-query JSONL: `/home/sikmindz/Coding/agent-memory-kits/docs/benchmarks/beir-scifact-ranking/ablations/stale-runtime/calibration-hybrid-per-query.jsonl` (`sha256:722da13591cfad6220c8bf9f7aef6102c96a91c10e420aba3544b6f92c7ffb96`)
...
```bash
python3 shared/scripts/benchmark-beir-scifact-ranking.py --work-dir .bench-data/beir-scifact-ranking --output-dir docs/benchmarks/beir-scifact-ranking/ablations/stale-runtime --model all-minilm:latest --dimensions 384 --max-chars 700 --mode hybrid --query-split calibration
```
