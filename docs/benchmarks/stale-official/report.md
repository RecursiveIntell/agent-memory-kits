...
- Per-case sidecar: `docs/benchmarks/stale-official/per-case.jsonl` (`sha256:5801705ae7a8184682dfa2a938ad60d1a4df7c0b68529093641526f4a1110a4e`)
...
|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| `semantic_memory` | 0.983 | 1.000 | 0.983 | 0.995 | 1.000 | 1.000 | 1.000 | 999.658245 | 0 |
...
```bash
python3 shared/scripts/benchmark-diagnostic-memory.py --official-stale-dataset .bench-data/stale/T1_T2_400_FULL.json --official-stale-launch-local --official-stale-cases-out docs/benchmarks/stale-official/per-case.jsonl --markdown-out docs/benchmarks/stale-official/report.md --out docs/benchmarks/stale-official/aggregate-receipt.json
```
